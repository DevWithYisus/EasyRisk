...
public class InyectarSantanderRCAQ extends javax.swing.JInternalFrame {
    ...
    String fechaCompra = desglorarCompra[3];
    String horaCompra = desglorarCompra[4];


    public InyectarSantanderRCAQ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Generar Tramas Getnet - RCAQ");
        ...
        comboTipoTrx.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione una opción", "Compra" }));
        ...
        try {
            ...
            switch (comboTipoTrx.getSelectedIndex()) {
                ...
                case 1:
                    ...
                    areaHercules.setText(desglorarCompra[0] + valorCompra + valor2Compra + fechaCompra + horaCompra + desglorarCompra[5]);
                    break;
            }
