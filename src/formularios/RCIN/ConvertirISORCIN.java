...
public class ConvertirISORCIN extends javax.swing.JInternalFrame {
    ...
    private void btnConvertirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConvertirActionPerformed
        ...
        try {
            ...
            String parteTarjeta = tramaDesdeISO.substring(50, 69);
            String parteValor = tramaDesdeISO.substring(69, 84);
            
            
            System.out.println(bin);
            System.out.println(primeraParte);
            System.out.println(parteTarjeta);
            System.out.println(parteValor);
